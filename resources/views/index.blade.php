    ...
    <main>
                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                                <img loading="lazy" src="{{ asset('uploads/slides') }}/{{ $item->image }}" width="542"
        ...
        <div class="container mw-1620 bg-white border-radius-10">
                                    ...
                                    @foreach ($sproduct as $item)
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    href="{{ route('shop.product.details', ['product_slug' => $item->slug]) }}">
                                                    <img loading="lazy"
                                            ...
                                            <div class="pc__info position-relative">
                                                <h6 class="pc__title"><a href="details.html">{{ $item->name }}</a>
                                                </h6>
            ...
            <section class="products-grid container">
                ...
                <div class="row">
                    @foreach ($fprodcut as $item)
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', $item->slug) }}">
                                ...
                                <div class="pc__info position-relative">
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', $item->slug) }}">{{ $item->name }}</a>
                                    </h6>
