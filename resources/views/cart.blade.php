                ...
                @if ($item->count() > 0)
                    <div class="cart-table__wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="qty-control position-relative">
                                                ...
                                                <form action="{{ route('cart.qty.decrease', ['rowId' => $items->rowId]) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="qty-control__reduce">-</div>
                                                </form>

                                                <form action="{{ route('cart.qty.increase', ['rowId' => $items->rowId]) }}"
                                                    method="POST">
                                                    @csrf
                                        ...
                                        <td>
                                            <span class="shopping-cart__subtotal">${{ $items->subtotal() }}</span>
                                        </td>
                                        <td>
                                            <form action="{{ route('cart.remove.item', $items->rowId) }}" method="POST">
                                                @csrf
                        ...
                        <div class="cart-table-footer">
                            ...
                            @endif
                            <form action="{{ route('cart.clear.items') }}" method="POST">
                                @csrf
