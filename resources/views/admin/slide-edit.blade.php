                        ...
                        <div class="upload-image flex-grow">
                            @if ($slides->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('uploads/slides') }}/{{ $slides->image }}" alt=""
                                        class="effects">
                                </div>
                            @endif
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select name="status">
                                ...
                                <option value="1" @if ($slides->status == '1') selected @endif>Active</option>
                                <option value="0" @if ($slides->status == '0') selected @endif>Inactive</option>
                            </select>
                        </div>
                        @error('status')
                            <span class="alert alert-danger text-center">{{ $message }}</span>
