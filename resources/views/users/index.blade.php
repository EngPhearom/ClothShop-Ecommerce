...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="{{ asset('users/images/icons/favicon.png') }}" />
    <!--===============================================================================================-->
...
<body class="animsition">
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<img src="{{ asset('users/images/icons/logo-01.png') }}" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="{{ asset('users/images/icons/logo-01.png') }}" alt="IMG-LOGO"></a>
			</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url({{ asset('users/images/slide-01.jpg') }});">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('users/images/banner-01.jpg') }}" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('users/images/banner-02.jpg') }}" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="{{ asset('users/images/banner-03.jpg') }}" alt="IMG-BANNER">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="{{ asset('users/images/product-01.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
									<img class="icon-heart1 dis-block trans-04" src="{{ asset('users/images/icons/icon-heart-01.png') }}" alt="ICON">
									<img class="icon-heart2 dis-block trans-04 ab-t-l" src="{{ asset('users/images/icons/icon-heart-02.png') }}" alt="ICON">
								</a>
							</div>
						</div>
					</div>
...
<!--===============================================================================================-->
	<script src="{{ asset('users/vendor/MagnificPopup/jquery.magnific-popup.min.js') }}"></script>
	<script>
